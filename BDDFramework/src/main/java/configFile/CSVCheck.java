...
public class CSVCheck 
{
		...
		public void csvFilecompare() throws FileNotFoundException
		{
	 
	        ArrayList<String> valuesInSheetOne = new ArrayList<String>();
	        ArrayList<String> valuesInSheetTwo = new ArrayList<String>();
	        
	        String Filecsv1 = "C:\\Users\\sanav\\Desktop\\csvData\\LotMaster.csv";
	        String Filecsv2 = "C:\\Users\\sanav\\Desktop\\csvData\\TaxLotMaster.csv";
	        File sheet1 = new File(Filecsv1);
	        File sheet2 = new File(Filecsv2);
